...
#define DG_SYSTEM_ABI_MINOR 5u
typedef void (*dg_system_event_callback_v1)(uint32_t kind, int64_t at_unix_ns, void *user_data);
enum { DG_SYSTEM_SLEEP=1, DG_SYSTEM_WAKE=2, DG_SYSTEM_SCREEN_LOCKED=3, DG_SYSTEM_SCREEN_UNLOCKED=4, DG_SYSTEM_SCREENSAVER_START=5, DG_SYSTEM_SCREENSAVER_STOP=6, DG_SYSTEM_DISPLAYS_CHANGED=7, DG_SYSTEM_APPLICATION_ACTIVATED=8, DG_SYSTEM_APPLICATION_HIDDEN=9, DG_SYSTEM_APPLICATION_UNHIDDEN=10 };
