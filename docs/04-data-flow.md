...
持续重写后，按有证据的活动 / 目标边界重新分卡。卡片最长 60 分钟；**没有最短 10 分钟限制**。
明确的短活动可以独立成卡，只有确属同一任务的相邻片段或偶发插曲才合并。不得为了凑时长从
无关活动借用分钟，否则卡片分类以及 daily / weekly 的专注、分心统计都会失真。
