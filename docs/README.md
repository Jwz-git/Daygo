...
- [特色功能机会研究（2026-09-26）](research/feature-opportunities-2026-09-26.md)：
  同类产品资料、八个候选方向与验证次序；属于研究建议，未进入交付范围。
...
| 前端默认语言 | `zh-CN`，回退 `en`；另发布 `zh-Hant` / `ja` / `ko` / `de` / `fr` / `es` / `pt-BR` | key 结构以 zh-CN 为类型来源，缺 key 时类型检查直接失败 |
