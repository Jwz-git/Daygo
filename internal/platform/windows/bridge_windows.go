...
#cgo LDFLAGS: -ld3d11 -ldxgi -ldxguid -lole32 -loleaut32 -lwindowscodecs -luser32 -lgdi32 -ladvapi32 -lmfplat -lmfreadwrite -lmfuuid -Wl,-Bstatic -lstdc++ -lwinpthread -Wl,-Bdynamic -lgcc -lgcc_eh
#include <stdlib.h>
