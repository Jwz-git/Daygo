export default {
  ...
  failure: {
    ...
    providerTitle: 'AI provider request failed',
    configurationTitle: 'No AI provider configured',
    providerSummary: '{count} failed ranges involve AI provider requests.',
    openProviders: 'Check AI provider settings',
    providerAction: 'Check the provider address, model, and key, then test the connection in Settings. Retry the failed range after it recovers.',
    configurationAction: 'Configure an AI provider and model, then retry the failed range.',
    applicationAction: 'Daygo could not process this range. Keep the failed range for diagnosis; repeatedly testing the provider will not fix this error.',
    reason: {
      auth: 'The provider rejected authentication. Check the key.',
      rate_limited: 'The provider limited the request rate or quota.',
      network: 'The provider connection timed out or was unavailable. Your local network may also be involved.',
      invalid_request: 'The provider rejected the request. Check the endpoint and model settings.',
      invalid_output: 'The model response could not be used to generate cards.',
      no_provider: 'No usable AI provider or model is configured.',
      application: 'Daygo could not analyze or save the card.',
    },
    ...
    retryHint: 'Resolve the cause before retrying the affected range.',
    stop: 'Stop retrying',
    ...
    detail: {
      ...
      notRetryable: 'Resolve the cause, then retry this batch manually.',
    },
  },
  copy: {
  ...
  reprocess: {
    ...
    card: 'Regenerate',
    cardConfirm: "This regenerates this card's own span only; the cards on either side stay as they are. Continue?",
  ...
  inspector: {
    ...
    ratingSaveFailed: "The rating wasn't saved; the previous one is kept.",
    ratingUnavailable: 'Read-only right now, so the summary cannot be rated.',
