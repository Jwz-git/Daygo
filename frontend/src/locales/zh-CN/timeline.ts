export default {
  ...
  failure: {
    title: '分析未完成',
    providerTitle: 'AI 服务商请求失败',
    configurationTitle: '尚未配置 AI 服务商',
    providerSummary: '{count} 个失败时段与 AI 服务商请求有关。',
    openProviders: '检查 AI 服务商设置',
    providerAction: '检查服务商地址、模型与密钥，并在设置中测试连接。恢复后可重试失败时段。',
    configurationAction: '先配置 AI 服务商与模型，再重试失败时段。',
    applicationAction: 'Daygo 处理这个时段时出错。请保留失败时段供诊断；反复测试服务商连接无法修复此错误。',
    reason: {
      auth: '服务商拒绝认证，请检查密钥。',
      rate_limited: '服务商限制了请求频率或额度。',
      network: '连接服务商时超时或不可用；也可能是本机网络问题。',
      invalid_request: '服务商拒绝了请求，请检查接口与模型配置。',
      invalid_output: '模型返回的内容无法用于生成卡片。',
      no_provider: '没有可用的 AI 服务商或模型。',
      application: 'Daygo 分析或写入卡片时出错。',
    },
    detailTitle: '失败详情',
    retry: '重试这个失败时段',
